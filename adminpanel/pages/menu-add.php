...
$sql=$db->query("SELECT * FROM content ORDER BY ranking ASC");
$sql2 = $db->query("SELECT COUNT(*) as num FROM content"); 
...
?>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <form action="/process/sayfaekle" method="post">
    ...
    <div class="form-group">
    <label for="selectError">Menü Sıralama</label>
    <div class="controls">
        <select id="selectError" data-rel="chosen" name="rank">
        <?php 	
		for($j = $rank[$row]+1; $j <= 10; $j++){		
    ...
    <div class="form-group">
        ...
        <textarea id="txtCkeditor" name="txtCkeditor" id="txtCkeditor"></textarea>
