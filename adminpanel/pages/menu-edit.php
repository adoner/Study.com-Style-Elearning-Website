...
$qry = $db->query("SELECT * FROM content WHERE id=$id")->fetch();
?>
<!DOCTYPE html>
<html lang="tr">
...
?>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <form action="/process/sayfaduzenle" method="post">
    <div class="form-group">
        <label for="title">Menü Adı</label>
        <input type="text" class="form-control" id="title" name="title" value="<?php echo $qry["title"];?>" required>
         
    </div>
    <div class="form-group">
        <label for="link">Dış Link</label>
        <input type="text" class="form-control" id="link" name="link" value="<?php echo $qry["link"];?>">
    </div>
    <br />
    <div class="form-group">
        <label for="icerik">Sayfa İçerik</label><br>
        <textarea id="txtCkeditor" name="txtCkeditor" id="txtCkeditor" ><?php echo $qry["contentbody"];?></textarea>
