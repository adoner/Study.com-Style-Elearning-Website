...
$qry=$db->query("SELECT * FROM content WHERE indpages='0' ORDER BY ranking ASC");
?>
<!DOCTYPE html>
<html lang="tr">
...
<td class='center'>
<a class='btn btn-info' href='/adminpanel/menus/menuduzenle?id=$menu[id]'>
	<i class='glyphicon glyphicon-edit icon-white'></i>
	Düzenle
</a>
<a class='btn btn-danger' href='#' data-toggle='confirmation'>
...
<tr><td colspan="4"><a href="/adminpanel/menus/menuekle" title="Menü Eklemek İçin Tıklayınız." data-placement="right" data-toggle="tooltip" class="btn btn-warning">Menü Ekle</a></td></tr>                    
</tbody>
</table>
