              ...
              <div class="card">
                <div class="card-header card-header-tabs card-header-primary">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title">İşlem:</span>
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#message" data-toggle="tab">
                            <i class="material-icons">bug_report</i> MESAJ
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#notification" data-toggle="tab">
                            <i class="material-icons">code</i> BİLDİRİM
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#email" data-toggle="tab">
                            <i class="material-icons">cloud</i> EPOSTA
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#sms" data-toggle="tab">
                            <i class="material-icons">cloud</i> SMS
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>
                ...
                <div class="card-body">
                  <div class="tab-content">
                    ...
                    <form class="navbar-form" action="/process/message" method="post">
                      <table width="70%" align="center">
                        <tbody>
                          <tr>
                            <td>
                            <div class="form-group">
                                  <label class="bmd-label-floating">Kullanıcı Türü</label>
                            <div class="form-check">
                                <label class="form-radio-label">
                                  <input name = "user" class="form-radio-input" type="radio" value="student">
                                  <span class="form-radio-sign">
                                    <span class="radio">Öğrenci</span>
                                  </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <input name = "user" class="form-radio-input" type="radio" value="tutor">
                                  <span class="form-radio-sign">
                                    <span class="radio">Eğitmen</span>
                                  </span>
                                </label>
                              </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <script> CKEDITOR.replace( 'messagebody' ,{
								filebrowserBrowseUrl: '/adminpanel/ckfinder/ckfinder.html',
    							filebrowserImageBrowseUrl: '/adminpanel/ckfinder/ckfinder.html?type=Images',
    							filebrowserUploadUrl: '/adminpanel/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
    							filebrowserImageUploadUrl: '/adminpanel/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images'		
								});	</script>
                          </div>
                        </div>
                            </td>
