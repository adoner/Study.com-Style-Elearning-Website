...
$qid = $_GET["qid"];
$qry = $db->query("SELECT * FROM questions_answers WHERE id = '$qid'")->fetch();
?>
<!DOCTYPE html>
<html lang="tr">
...
<div class="content">
<!--//content here-->
<a href="../../uploads/questions/<?php echo $qry["questionName"];?>" data-fancybox="gallery" data-caption="Soru">
<img src="../../uploads/questions/<?php echo $qry["questionName"];?>" class="imcss"/>
</a>
<a href="../../uploads/questions/<?php echo $qry["questionName"];?>" data-fancybox="gallery" data-caption="Çözüm">
<img src="../../uploads/questions/<?php echo $qry["questionName"];?>" class="imcss"/>
</a>
